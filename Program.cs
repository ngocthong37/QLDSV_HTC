...
namespace QLNV1
{
    static class Program
    {
        ...
        public static String connstr_publicsher = "Data Source=NGUYENNGOCTHONG;Initial Catalog=QLDSV_HTC;Integrated Security=True";
        public static SqlDataReader myReader;
        public static String severname = "QLDSV_HTC";
